...
响应格式:
{
    ...
    "data": {
        "list": [
            {
                "id": 1,
                "file": "http://jiankangpaika.blcwg.com/data/videos/task_video_1.mp4",
                "url": "https://example.com/task1",
                "title": "每日任务标题",
                "image": "http://jiankangpaika.blcwg.com/data/images/task_cover_1.jpg",
                "switch": 1,
...
媒体文件URL配置:
- 基础域名: http://jiankangpaika.blcwg.com/
- 视频路径: /data/videos/
- 图片路径: /data/images/
- 支持外部URL直接返回
