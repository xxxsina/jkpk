...
class WorkerManager {
    ...
    public function __construct() {
        // 注册所有Worker类
        $this->workers = [
            'user_operations' => UserOperationsWorker::class,
            'user_log' => UserLogWorker::class,
            'checkin' => CheckinWorker::class,
            'qiandao_log' => QiandaoLogWorker::class,
            'login_log' => LoginLogWorker::class,
            'customer_message' => CustomerMessageWorker::class,
        ];
    }
