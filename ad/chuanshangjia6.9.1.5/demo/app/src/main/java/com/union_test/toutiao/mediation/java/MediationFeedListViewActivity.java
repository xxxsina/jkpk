...
/**
 * 融合demo，Feed流广告 ListView接入 使用示例（模板和自渲染）。更多功能参考接入文档。
 *
 * 注意：每次加载的广告，只能展示一次
 *
 * 接入步骤：
...
public class MediationFeedListViewActivity extends Activity {
    ...
    private void initListView() {
        mListView = findViewById(R.id.feed_listview);
        mData = new ArrayList<>();
        mAdapter = new MediationFeedListViewAdapter(this, mData);
    ...
    private void initListeners() {
        ...
        this.mFeedAdListener = new TTAdNative.FeedAdListener() {
            ...
            public void onError(int code, String message) {
                ...
                Toast.makeText(MediationFeedListViewActivity.this, message, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFeedAdLoad(List<TTFeedAd> ads) {
                ...
                if (ads == null || ads.isEmpty()) {
                    Toast.makeText(MediationFeedListViewActivity.this,
